			...
			<div class="layui-row">
				<form class="layui-form layui-col-md12 we-search" action="" method="get">
					...
					<div class="layui-inline">
						<input type="text" name="likeuser" placeholder="请输入用户名" autocomplete="off" class="layui-input">
					</div>
			...
			<table class="layui-table">
				...
				<c:forEach items="${userlist}" var="item" varStatus="i">
					<tr>
						...
						<td class="td-manage">
							<a title="编辑"  target="_blank" href="<%=request.getContextPath() %>/admin/edituser?username=${item.username}">
			...
			layui.use(['layer', 'form','jquery'], function(){
			  ...
			  tbody.addEventListener("click",function(e){
			  	...
			  	if(e.target.parentElement.className=="delbtn"){
			  		...
			  		var alertId = layer.confirm('是否确认删除id为'+id+"的"+username+"?", {
			  ...
			  $("#pdelBtn").click(function(){
				...
				var alertId = layer.confirm('是否确认批量删除id为'+delIdList+"?", {
				  btn: ['考虑一下', '确认删除'], //可以无限个按钮
				  area: ['500px', '300px']
				}, function(index, layero){
					//关闭弹框
