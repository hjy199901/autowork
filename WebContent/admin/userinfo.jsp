    ...
    <div class="weadmin-body" >
        <form class="layui-form" action="<%=request.getContextPath() %>/admin/userinfo" method="post">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" value="${user.mail }" id="L_email" name="mail" required="" lay-verify="email"
                  autocomplete="off" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" value="${user.age }" id="L_email" name="age" required=""
                  autocomplete="off" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
                  <span class="we-red">*</span>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" value="${user.brief }" id="L_email" name="brief" required="" 
                  autocomplete="off" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
                  <span class="we-red">*</span>
          ...
          <div class="layui-form-item">
              ...
              <c:if test="${user.userType=='admin'}">
                ...
                <input type="radio" name="userType" lay-skin="primary" value="patient" title="患者人员" >
              </c:if>
              
              <c:if test="${user.userType=='doctor'}">
              	<input type="radio" name="userType" lay-skin="primary" value="admin" title="超级管理员" >
                <input type="radio" name="userType" lay-skin="primary" value="doctor" title="医生人员"  checked="">
                <input type="radio" name="userType" lay-skin="primary" value="patient" title="患者人员" >
              </c:if>
              ...
              <c:if test="${user.userType=='patient'}">
              	<input type="radio" name="userType" lay-skin="primary" value="admin" title="超级管理员" >
                <input type="radio" name="userType" lay-skin="primary" value="doctor" title="医生人员">
                <input type="radio" name="userType" lay-skin="primary" value="patient" title="患者人员" checked="">
              </c:if>
